...
struct SettingsView: View {
    ...
    "AppIcon-MagnifyingGlass","AppIcon-Map","AppIcon-Mushroom","AppIcon-Camera","AppIcon-Backpack","AppIcon-Campfire"
    ]
    var body: some View {
        List {
            // MARK: - SECTION: HEADER
            ...
            Section { ScrollView(.horizontal, showsIndicators: false) {
                    ...
                    ForEach(alternateAppIcons.indices, id: \.self) { item in
                        Button {
                            ...
                            UIApplication.shared.setAlternateIconName(alternateAppIcons[item]) { error in
                                if error != nil{
                                    print("Faied to update appicon: \(String(describing: error?.localizedDescription))")
                                }
                                else{
                                    print("success")
                                }
            ...
            .padding(.top, 12)
                Text("Choose your favorite app icon from the collection abobe.")
